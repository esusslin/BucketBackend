...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { item: @proposal.item, user_id: @proposal.user_id } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { item: @proposal.item, user_id: @proposal.user_id } }
